            ...
            <table class="table fs-7">
                ...
                <tbody>
                    ...
                    <tr v-for="row in history.slice(0, items)">
                        ...
                        <td class="dark-background" scope="row" v-if="quality && (row['amount']/row['volume'] < 1)">{{formatNumber(row['amount']/row['volume'])}}</td>
                        <td class="dark-background" scope="row" v-else-if="quality">{{formatNumber(row['volume']/row['amount'])}}</td>
                    </tr>
                </tbody>
            </table>
        </div>
